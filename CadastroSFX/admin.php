...
<html lang="en">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">SFX Sistemas | Tabela De Usuários Cadastrados</a>
    ...
    <br>
    <?php
        echo "<h1>Administrador: <u>$logado</u></h1>";
    ?>
    <br>
        ...
        <table class="table text-black table-bg" id="tabela">
            <thead>
                <tr>
                    ...
                    <th scope="col">Hobbie Favorito</th>
